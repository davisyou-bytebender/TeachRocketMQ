 ...
 * @author davisyou
 * @version 1.0
 * @date 2022/11/23 8:59 PM
 */
public class Consumer {
    public static void main(String[] args) throws MQClientException {
        DefaultMQPushConsumer defaultMQPushConsumer = new DefaultMQPushConsumer("broadcast_consumer");
        defaultMQPushConsumer.setNamesrvAddr("localhost:19876");
        defaultMQPushConsumer.subscribe("single_way_message", "*");
